const jobs = [
  ...
  },
  {
    ...
    description: [
      ...
      "Paticipated in the company’s daily decision making and marketing to increase returns/profits also improving client statisfactions through meetings.",
  ...
  },
  {
    ...
    position: "Wallet Funding Officer, Customer Care Representative",
    duration: "March 2019 - December 2021",
    description: [
      "Manually computed client fail wallet funding into client account on the website using administrator backend dashboard.",
      "cross checking the authenticity of payment documents to avoid the funding of false payment and tracking of records to avoid redundancy. All inother to mitigate fraud and or loss.",
